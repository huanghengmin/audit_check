...
public class AuditProcessAction extends ActionSupport {
    ...
    public String update() throws Exception {
     ...
     /*   String build_num_flag = request.getParameter("build_num_flag");
        ...
        if (replay_flag == null)
            replay_flag = "";
        String admin_verity_flag = request.getParameter("admin_verity_flag");
        if (admin_verity_flag == null)
            admin_verity_flag = "";
        String tamper_flag = request.getParameter("tamper_flag");
        if (tamper_flag == null)
            tamper_flag = "";
        String fault_flag = request.getParameter("fault_flag");
        if (fault_flag == null)
            fault_flag = "";
        boolean flag = ProcessXMLUtils.save(audit_flag, verity_flag, client_flag, admin_flag, build_flag,
         /*build_num_flag,*/ full_flag, decode_flag, discard_flag, storage_flag,
                replay_flag,admin_verity_flag,tamper_flag,fault_flag);
        if (flag) {
            msg = "保存成功";
