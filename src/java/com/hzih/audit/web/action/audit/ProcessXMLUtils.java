...
public class ProcessXMLUtils {
    ...
    public static final String admin_verity_flag = "admin_verity_flag";
    public static final String tamper_flag = "tamper_flag";
    public static final String fault_flag = "fault_flag";
...
//            Element build_num_flag_el = config.element(build_num_flag);
            ...
            Element admin_verity_flag_el = config.element(admin_verity_flag);
            Element tamper_flag_el = config.element(tamper_flag);
            Element fault_flag_el = config.element(fault_flag);
...
//            sb.append("build_num_flag:'" + build_num_flag_el.getText() + "',");
            ...
            sb.append("admin_verity_flag:'" + admin_verity_flag_el.getText() + "',");
            sb.append("tamper_flag:'" + tamper_flag_el.getText() + "',");
            sb.append("fault_flag:'" + fault_flag_el.getText() + "',");
    ...
    public static boolean save(
       ...
       /* Element build_num_flag_el = config.addElement(ProcessXMLUtils.build_num_flag);
        ...
        Element admin_verity_flag_el = config.addElement(ProcessXMLUtils.admin_verity_flag);
        admin_verity_flag_el.setText(admin_verity_flag);

        Element tamper_flag_el = config.addElement(ProcessXMLUtils.tamper_flag);
        tamper_flag_el.setText(tamper_flag);

        Element fault_flag_el = config.addElement(ProcessXMLUtils.fault_flag);
        fault_flag_el.setText(fault_flag);
