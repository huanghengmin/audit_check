...
public class LicenseUtils {
    ...
    public List<String> getNeedsLicenses(boolean isExistLicense) {
        ...
        String xtManager = "TOP_XTGL:SECOND_PTSM:SECOND_PTGL:SECOND_ZSGL:SECOND_BBSJ:SECOND_FWGL:"; //系统管理
        String sjManager = "TOP_SJGL:SECOND_GLRZ:SECOND_RZXZ:";
        String pzManager = "TOP_PZGL:SECOND_BJPZ:";
        String ywManager = "TOP_YWSJ:SECOND_SJCL:SECOND_SJCC:SECOND_SJFX:SECOND_GLCZ:SECOND_KHCZ:";         //审计管理
        String jkManager = "TOP_JKGL:SECOND_ZJJK";   //监控管理
        String permission = qxManager + wlManager + xtManager + sjManager +pzManager+ywManager+ jkManager;
        if (isExistLicense) {
            try {
