...
function(el){
    ...
    // do something with the dom node
         ...
         * </ul></div>
         * @param {Mixed} value The value to MergeFiles
         ...
         * @param {Object} object The object to MergeFiles
         * @return {Boolean}
         */
        isDate : function(v){
            ...
            if(options){
                ...
                if(xmlData || jsonData){
                    ...
                    if(!hs || !hs[CONTENTTYPE]){
                        initHeader(CONTENTTYPE, xmlData ? 'text/xml' : 'application/com.hzih.audit.json');
                    }
