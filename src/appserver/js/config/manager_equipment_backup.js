                ...
                handler:function(){
                    if (initForm1.form.isValid()) {
                        initForm1.getForm().submit({
                            url :'../../BackupAction_update.action',
                            method :'POST',
                            waitTitle :'系统提示',
                            waitMsg :'正在保存,请稍后...',
...
//                                            location.reload();
    ...
    var initForm1 = new Ext.form.FormPanel({
        ...
        items:[{
            ...
            fieldLabel:'设备类型',
            hiddenName:'backUp.isMainSystem',
            xtype:'combo',
            mode:'local',
            emptyText :'--请选择--',
            editable : false,
...
//            fieldLabel:'主设备服务状态',
            name:'backUp.backupStatus',
            xtype:'hidden'
        },{
            id:'backupIp.info',
            fieldLabel:'副设备IP',
            name:'backUp.backupIp'
        },{
            id:'backupPort.info',
            fieldLabel:'副设备端口',
            name:'backUp.backupPort'
        },{
        	fieldLabel:"Ping策略",
        	id:'restarttime.info',
...
function ping_win() {
    ...
    var proxy = new Ext.data.HttpProxy({
        url:"../../BackupAction_queryList.action?type=ping"
    });
    var reader = new Ext.data.JsonReader({
        totalProperty:"total",
        root:"rows"
        ...
        Ext.MessageBox.show({
            ...
            fn:function(e){
                if(e=='ok'){
                    ...
                    myMask.show();
                    Ext.Ajax.request({
                        url : '../../BackupAction_insertList.action?type=pings',
                        params :{array : array },
        ...
        Ext.MessageBox.show({
            ...
            fn:function(e){
                if(e=='ok'){
                    ...
                    myMask.show();
                    Ext.Ajax.request({
                        url : '../../BackupAction_deleteList.action?type=pings',    // 删除 连接 到后台
                        params :{array : array },
                        success : function(r,o){
                            var respText = Ext.util.JSON.decode(r.responseText);
                            var msg = respText.msg;
                            ...
                            fn:function(e){
                                if(e=='ok'){
                                    formPanel.getForm().submit({
                                        url :'../../BackupAction_updateList.action?type=pings',
                                        method :'POST',
                                        waitTitle :'系统提示',
                                        waitMsg :'正在保存...',
                                        success : function(form,action) {
...
function telnet_win() {
    ...
    var proxy = new Ext.data.HttpProxy({
        url:"../../BackupAction_queryList.action?type=telnet"
    });
    var reader = new Ext.data.JsonReader({
        totalProperty:"total",
        root:"rows"
        ...
        Ext.MessageBox.show({
            ...
            fn:function(e){
                if(e=='ok'){
                    ...
                    myMask.show();
                    Ext.Ajax.request({
                        url : '../../BackupAction_insertList.action?type=telnets',
                        params :{array : array },
                        success : function(r,o){
                            var respText = Ext.util.JSON.decode(r.responseText);
                            var msg = respText.msg;
        ...
        Ext.MessageBox.show({
            ...
            fn:function(e){
                if(e=='ok'){
                    ...
                    myMask.show();
                    Ext.Ajax.request({
                        url : '../../BackupAction_deleteList.action?type=telnets',    // 删除 连接 到后台
                        params :{array : array },
                        success : function(r,o){
                            var respText = Ext.util.JSON.decode(r.responseText);
                            var msg = respText.msg;
                    ...
                    if (formPanel.form.isValid()) {
                        Ext.MessageBox.show({
                            ...
                            fn:function(e){
                                if(e=='ok'){
                                    formPanel.getForm().submit({
                                        url :'../../BackupAction_updateList.action?type=telnets',
                                        method :'POST',
                                        waitTitle :'系统提示',
                                        waitMsg :'正在保存...',
                                        success : function(form,action) {
...
function other_win() {
    ...
    var proxy = new Ext.data.HttpProxy({
        url:"../../BackupAction_queryList.action?type=other"
    });
    var reader = new Ext.data.JsonReader({
        totalProperty:"total",
        root:"rows"
        ...
        Ext.MessageBox.show({
            ...
            fn:function(e){
                if(e=='ok'){
                    ...
                    myMask.show();
                    Ext.Ajax.request({
                        url : '../../BackupAction_insertList.action?type=others',
                        params :{array : array },
                        success : function(r,o){
                            var respText = Ext.util.JSON.decode(r.responseText);
                            var msg = respText.msg;
        ...
        Ext.MessageBox.show({
            ...
            fn:function(e){
                if(e=='ok'){
                    ...
                    myMask.show();
                    Ext.Ajax.request({
                        url : '../../BackupAction_deleteList.action?type=others',    // 删除 连接 到后台
                        params :{array : array },
                        success : function(r,o){
                            var respText = Ext.util.JSON.decode(r.responseText);
                            var msg = respText.msg;
                    ...
                    if (formPanel.form.isValid()) {
                        Ext.MessageBox.show({
                            ...
                            fn:function(e){
                                if(e=='ok'){
                                    formPanel.getForm().submit({
                                        url :'../../BackupAction_updateList.action?type=others',
                                        method :'POST',
                                        waitTitle :'系统提示',
                                        waitMsg :'正在保存...',
                                        success : function(form,action) {
